...
local saveFile = "WataX_Key_Mtl.txt"
...
local function isKeyValid(k)
    local url = "https://raw.githubusercontent.com/WataXScript/WataXMountLembayana/main/Loader/eldl/"..k
...
if lastKey and isKeyValid(lastKey) then
    ...
    mainFrame.Visible = false
    loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/WataXScript/WataXMountLembayana/main/Loader/WataX.lua"))()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/WataXScript/WataXMountLembayana/main/Loader/mainmap772.lua"))()
end
